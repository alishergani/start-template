$(document).ready(function () {
    // Gallery
    const gallery = $('.js-gallery2');
    const galleryWrap = $('.js-gallery2-wrap');

    const galleryModal = $('#galleryModal');

    const galleryThumbnails = $('.js-gallery2-thumbnail');
    ...
    const galleryImage = $('.js-gallery2-image');
    const galleryVideo = $('.js-gallery2-video');

    const galleryModalThumbnails = $('.js-gallery2-modal-thumbnail');
    ...
    function triggerThumbnail(element, index) {
        ...
        if (!element.hasClass('active')) {
            ...
            if (element.data('type') == 'image') {
                ...
                galleryImage.attr('src', `${imageSet[0]}`);
                if(imageSet[1]){
                    galleryImage.attr('srcset', `${imageSet[0]} 1x, ${imageSet[1]} 2x`);
                }
                galleryVideo.hide();
                galleryImage.show();
