$(document).ready(function () {
    ...
    const sliderImage = $('.js-slider-image');
    const sliderVideo = $('.js-slider-video');

    const sliderThumbnails = $('.js-slider-thumbnail');
    ...
    function triggerThumbnail(element, index) {
        ...
        if (!element.hasClass('active')) {
            ...
            if (element.data('type') == 'image') {
                ...
                sliderImage.css('background-image', `url(${imageSet[0]}`);
                if (isRetina()) {
                    sliderImage.css('background-image', `url(${imageSet[1]}`);
                }
                sliderVideo.hide();
                sliderImage.show();
